...
2. **Phone access** (Tailscale + PWA) — the older deferred roadmap item
3. **LLM-history import**: distill Idris's ChatGPT/Claude.ai chat exports into topic notes in the vault (pipeline designed 2026-07-12 — waiting on Idris to download the export ZIPs to `Documents\llm-exports`)
